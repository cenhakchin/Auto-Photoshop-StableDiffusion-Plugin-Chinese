...
【2023-06-08】 用户反馈
Q：找不到..\Plug-ins\Auto.Photoshop.SD.plugin_v1.2.5\..路径

A：先确认是否已安装了@AbdullahAlfaraj的插件，并部署了本地A1111环境；
方法：1.先移安装[点我下载.zip](https://github.com/AbdullahAlfaraj/Auto-Photoshop-StableDiffusion-Plugin/releases/download/v1.2.5/Auto.Photoshop.SD.plugin_v1.2.5.zip);2.解压到文件夹整个复制到"C:\\Program Files\Adobe\Adobe Photoshop 2023\Plug-ins\"里;3.再执行以上步骤的安装..
